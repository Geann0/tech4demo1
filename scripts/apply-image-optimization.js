...
async function applyImageOptimization() {
  ...
  try {
    ...
    for (const file of files) {
      ...
      if (
        content.includes("OptimizedProductImage") ||
      ...
      results.push({
        ...
        recommendation:
          "Replace Image/img tags with OptimizedProductImage, OptimizedHeroImage, etc.",
      });
    }
    ...
    console.log(
      "      import { OptimizedProductImage, OptimizedHeroImage } from '@/lib/imageOptimization'"
    );
