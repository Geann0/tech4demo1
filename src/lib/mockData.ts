...
export const mockProducts = [
  {
    ...
    short_description:
      "Fone sem fio com cancelamento de ruído e 30h de bateria",
    description:
      "Fone de ouvido sem fio com cancelamento de ruído ativo, bateria de até 30 horas e som de alta fidelidade. Perfeito para trabalho e entretenimento.",
    price: 299.9,
    image_urls: [
  ...
  },
  {
    ...
    short_description:
      "Relógio inteligente com monitoramento completo e 7 dias de bateria",
    description:
      "Relógio inteligente com monitoramento de saúde completo, GPS integrado, resistente à água e bateria de 7 dias. Compatível com iOS e Android.",
    price: 899.9,
    image_urls: [
  ...
  },
  {
    ...
    short_description:
      "Teclado mecânico com iluminação RGB e estrutura em alumínio",
    description:
      "Teclado mecânico com switches blue, iluminação RGB customizável, teclas anti-ghosting e estrutura em alumínio. Ideal para games e digitação.",
    price: 449.9,
    image_urls: [
  ...
  },
  {
    ...
    short_description:
      "Mouse de alta precisão 16000 DPI com 8 botões programáveis",
    description:
      "Mouse sem fio de alta precisão com sensor óptico de 16000 DPI, 8 botões programáveis e bateria recarregável de 60 horas.",
    price: 189.9,
    image_urls: [
  ...
  },
  {
    ...
    description:
      "Câmera web Full HD 1080p com microfone embutido, autofoco e correção automática de luz. Perfeita para videoconferências e streaming.",
    price: 349.9,
    image_urls: [
  ...
  },
  {
    ...
    description:
      "Base de carregamento sem fio com tecnologia de carga rápida de 15W. Compatível com smartphones, fones e smartwatches.",
    price: 129.9,
    image_urls: [
  ...
  },
  {
    ...
    description:
      "Bateria externa de alta capacidade com carregamento rápido USB-C PD e 3 portas de saída. Ideal para viagens e uso diário.",
    price: 199.9,
    image_urls: [
  ...
  },
  {
    ...
    description:
      "Suporte ajustável em alumínio com 6 níveis de altura, ventilação integrada e design ergonômico para melhor postura.",
    price: 149.9,
    image_urls: [
      "https://images.unsplash.com/photo-1625948515291-69613efd103f?w=800&h=800&fit=crop",
