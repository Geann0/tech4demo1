...
-- NOTE: profiles.id is the primary key (not user_id)
-- The user_id column exists only in child tables (orders, addresses, reviews, etc.)
-- Supabase-managed profiles table links to auth.uid() via profiles.id
